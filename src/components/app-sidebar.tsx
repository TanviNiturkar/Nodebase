...
const {hasActiveSubscription,isLoading} = useHasActiveSubscription();
    ...
    return (
        <Sidebar collapsible="icon">
            ...
            <SidebarContent> {menuItems.map((group)=>(
            ...
            <SidebarFooter>
                <SidebarMenu>
                    ...
                    <SidebarMenuItem>
                        ...
                        className="gap-x-4 h-10 px-4" onClick={()=>authClient.checkout({slug:"pro"}) }>
                      ...
                      <SidebarMenuItem>
                        ...
                        className="gap-x-4 h-10 px-4" onClick={()=> authClient.customer.portal()}>
                      ...
                      <SidebarMenuItem>
                        ...
                        className="gap-x-4 h-10 px-4" onClick={()=>authClient.signOut({
                            fetchOptions:{
